...
function SocialLink({
  ...
  return (
    ...
    >
      <span
        className="text-lg opacity-80 group-hover:opacity-100"
        style={{ color }}
      >
        {icon}
      </span>
    ...
    <main className="home-bg min-h-screen flex flex-col items-center justify-center relative p-6 pt-28 overflow-hidden">
      ...
      >
        ...
        <p className="text-sm md:text-base text-gray-400 leading-relaxed tracking-wide max-w-2xl mx-auto mb-8 font-sans">
          Sou um Desenvolvedor Fullstack focado em construir aplicações
          modernas, escaláveis e de alta performance. Combino a agilidade do
          ecossistema Frontend (React, Next.js, Tailwind CSS) com a robustez e
          resiliência de arquiteturas de servidores complexos tanto em Node.js
          quanto em ecossistemas corporativos com Java e Spring Boot.
        </p>
        ...
        <div className="flex justify-center gap-6 mb-10">
          ...
          />
          <SocialLink
            href="https://linkedin.com/in/lucas-nobrega1"
            icon={<FaLinkedin />}
            label="LinkedIn"
            color="#0077B5"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6 text-left">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <TechIcon Icon={DiJava} name="Java" color="#007396" />
